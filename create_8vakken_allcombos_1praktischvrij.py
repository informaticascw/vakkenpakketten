...
BASE_FILENAME: str = "vwo_8vakken_allcombos_1praktischvrij"
...
FREE_CHOICE_SUBJECTS: Set[str] = {"ak", "beco", "biol", "chtc",       "dutl", "econ",         "fatl", "fi", "ges",        "in",        "mu", "nat",         "schk", "sptl", "te",                         "wisd"}
